                        ...
                        <div class="top-bar-wrap">
                            <div class="top-bar-left">
                                <div class="top-bar-text">
                                    {{ strip_tags(App\Models\SiteConfig::getAllStiteConfig()->httext) }}</div>
                            </div>
                            <div class="top-bar-right">
                                <ul class="top-bar-info">
                                    <li class="info-item">
                                        <a href="tel:{{ App\Models\SiteConfig::getAllStiteConfig()->phone }}"
                                            class="info-link">
                                            <i class="info-icon fa fa-phone"></i>
                                            <span
                                                class="info-text"><strong>{{ App\Models\SiteConfig::getAllStiteConfig()->phone }}</strong></span>
                                        </a>
                                    </li>
                                    <li class="info-item">
                                        <i class="fal fa-envelope"></i>
                                        <a href="mailto:{{ App\Models\SiteConfig::getAllStiteConfig()->email }}"
                                            class="hover-style-link">{{ App\Models\SiteConfig::getAllStiteConfig()->email }}</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="header position-relative">
                            ...
                            <div class="header__logo">
                                <a href="index.html">
                                    <img src="{{ asset('' . App\Models\SiteConfig::getAllStiteConfig()->logo) }}"
                                        class="img-fluid" alt="">
                                </a>
                            </div>
                                        ...
                                        <ul>
                                            ...
                                            <li class="has-children has-children--multilevel-submenu">
                                                ...
                                                <ul class="submenu">
                                                    ...
                                                    <li><a href="{{ route('contact') }}"><span>Contact us</span></a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="has-children has-children--multilevel-submenu">
                                            ...
                                            <li class="has-children has-children--multilevel-submenu">
                                                ...
                                                <ul class="submenu">
                                                    <li><a href="blog-list-large-image.html"><span>Photo
                                                                Gallery</span></a></li>
                                                    <li><a href="blog-list-large-image.html"><span>Video
                                                                Gallery</span></a></li>
                    ...
                    <div class="row footer-widget-wrapper">
                        <div class="col-lg-4 col-md-6 col-sm-6 footer-widget">
                            ...
                            <ul class="footer-widget__list">
                                <li><i class="info-icon fa fa-map-marker-alt"> </i>
                                    {{ App\Models\SiteConfig::getAllStiteConfig()->address }}</li>
                                <li><i class="fal fa-envelope"> </i> <a
                                        href="mailto:{{ App\Models\SiteConfig::getAllStiteConfig()->email }}"
                                        class="hover-style-link">{{ App\Models\SiteConfig::getAllStiteConfig()->email }}</a>
                                </li>
                                <li><i class="info-icon fa fa-phone"> </i> <a
                                        href="tel:{{ App\Models\SiteConfig::getAllStiteConfig()->phone }}"
                                        class="hover-style-link text-black font-weight--bold">{{ App\Models\SiteConfig::getAllStiteConfig()->phone }}</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 footer-widget">
                            ...
                            <ul class="footer-widget__list">
                                @foreach (App\Models\Service::getSixService() as $service)
                                    <li><a href="{{ route('service.show', $service->id) }}"
                                            class="hover-style-link p">{{ $service->name }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                        <div class="col-lg-4 col-md-8 col-sm-12 footer-widget">
                            <h6 class="footer-widget__title mb-20 text-left">Connect With Us</h6>
                            <div class="fb-page" data-href="{{ App\Models\Social::getSocial()->facebook_page }}"
                                data-tabs="timeline" data-width="" data-height="180px" data-small-header="false"
                                data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
                                <blockquote cite="{{ App\Models\Social::getSocial()->facebook_page }}"
                                    class="fb-xfbml-parse-ignore"><a
                                        href="{{ App\Models\Social::getSocial()->facebook_page }}">Facebook</a>
                                </blockquote>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-6 text-center text-md-left">
                            <span class="copyright-text">&copy; 2019
                                {{ App\Models\SiteConfig::getAllStiteConfig()->company_name }}. <a href="#">All
                                    Rights
                                    Reserved.</a></span>
                        </div>
