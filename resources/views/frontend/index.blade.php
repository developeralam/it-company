                    ...
                    <a href="{{route('product.show', $product->id)}}" class="ht-box-images style-03 wow move-up">
                        <div class="image-box-wrap">
                            ...
                            <div class="content">
                                ...
                                <div class="text">{{Str::of(strip_tags($product->short_description))->limit(100)}}</div>
                            </div>
                        </div>
                    </a>
                    <!-- ht-box-icon End -->
                ...
                <div class="col-lg-6">
                    <div class="faq-custom-col">
                        <div class="section-title-wrap">
                            ...
                            <p class="text mt-30">{{Str::of(strip_tags(App\Models\AboutUs::getAboutUs()->short_description))->limit(250) }}</p>
                                        ...
                                        <div class="icon-box-wrap">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text text-justify">{{Str::of(strip_tags($service->short_description))->limit(250)}}</p>
                ...
                <div class="col-lg-4">
                    <div class="contact-info sytle-one service-contact text-left">
                        ...
                        <div class="contact-info-title-wrap text-center">
                            <h3 class="heading text-white mb-10">Get In Touch</h3>
                        </div>
                        ...
                        <div class="contact-list-item">
                            <a href="" class="single-contact-list">
                                <div class="content-wrap">
                                    <div class="content">
                                        <div class="icon">
                                            <span class="info-icon fa fa-map-marker-alt"></span>
                                        </div>
                                        <div class="main-content">
                                            <h6 class="heading">Find Us</h6>
                                            <div class="text text-justify" style="font-size:17px;">{{App\Models\SiteConfig::getAllStiteConfig()->address}}</div>
                                        </div>
                                    </div>
                                </div>
                            </a>
                                ...
                                <div class="content-wrap">
                                    <div class="content">
                                        ...
                                        <div class="main-content">
                                            ...
                                            <div class="text text-justify" style="font-size:17px;">{{App\Models\SiteConfig::getAllStiteConfig()->phone}}</div>
                                        </div>
                                    </div>
                                </div>
                            </a>
                                ...
                                <div class="content-wrap">
                                    <div class="content">
                                        ...
                                        <div class="main-content">
                                            ...
                                            <div class="text text-justify" style="font-size:17px;">{{App\Models\SiteConfig::getAllStiteConfig()->email}}</div>
                                        </div>
                                    </div>
                                </div>
                            </a>
