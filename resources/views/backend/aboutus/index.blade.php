            ...
            <div class="card-body">
                <div class="site-config-form">
                    <form action="{{ $about ? route('aboutus.update', $about->id): route('aboutus.store') }}" method="post" class="w-75 m-auto" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="short_description" class="col-form-lebel">Shrot Description</label>
                            <textarea name="short_description" id="editor1" cols="30" rows="10">{{old('short_description', $about->short_description??null)}}</textarea>
                            <div class="text-danger">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="editor2" cols="30" rows="10">{{old('description', $about->description??null)}}</textarea>
                            <div class="text-danger">
                                @error('description')
                                    <span>
                                        <strong>{{$message}}</strong>
